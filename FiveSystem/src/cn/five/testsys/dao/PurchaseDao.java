...
import cn.five.testsys.entity.Purchase;
import cn.five.testsys.mapper.PurchaseMapper;
...
public class PurchaseDao {
	private PurchaseMapper pm ;
	{
        try {
            ...
            pm = session.getMapper(PurchaseMapper.class ) ;
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
	public Purchase getPurchase_dem_id(int dem_id) {return pm.getPurchase_dem_id(dem_id);}
