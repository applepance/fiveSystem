...
<body>
	<div>
    <form action="check_requisition_Queen.jsp" method="POST" target="_self" accept-charset="UTF-8" name="form1" onsubmit="return not_empty();">
    ...
    <%if(reqInfo.getDep_id()==0){ %>
    	<p><a href="check_requisition_Queen_pass.jsp?req_id=<%=reqInfo.getReq_id()%>">通过&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
    	<a href="check_requisition_Queen_faile.jsp?req_id=<%=reqInfo.getReq_id()%>">不通过&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
    	</p>
    <%
    }
    %>
