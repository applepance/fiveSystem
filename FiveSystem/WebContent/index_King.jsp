...
if(session.getAttribute("power")==null){
	...
	if(session.getAttribute("power")!="King"){
		response.sendRedirect(login_Func.check_power((String)session.getAttribute("power")));
	}
%>
<body>
<div class="head" style="background-image: url(images/head_4.jpg); scrollshow='true';" >
		<div class="nav-menu">
          <div class="blur-bg" style="background-image: url(images/head_4.jpg);"></div>
          <div class="nav-mask"></div>
          <div class="nav-wrapper clearfix wrapper">
              <div class="nav-con fr">
                  <ul class="fr">
                      <li class="nav-item">
                          <a href="index_King.jsp" target="_self" class="t"><%=(String)session.getAttribute("uname") %></a>
                      </li>
                      <li class="nav-item">
	...
	<div class="main-body">
		...
		<div class="nav-tab-bar">
			<a href="index_King.jsp" target="_self" class="tab-item on" style="background-image: url(images/log.jpg);height: 29.23px;">
    		</a>
    		<a href="index_King.jsp" target="_self" class="tab-item on">
      			<span>首页</span>
    		</a>
    		<a href="check_goods_King.jsp" target="_blank" class="tab-item  ">
      			<span>查询占用物资</span>
    		</a>
    		<a href="select_requisition.jsp" target="_blank" class="tab-item  ">
      			<span>查询历史审批单</span>
    		</a>
    		<a href="check_requisition_King.jsp" target="_blank" class="tab-item  ">
      			<span>查看尚未完成单</span>
    		</a>
    	</div>
                ...
                <div class="message-item">
                    <div class="item-holder">
                        <div class="message-content">
                                <a href="check_requisition_King.jsp?req_id=<%=req_id %>" target="_blank" class="message-title-holder">
    	...
    	<% if (total>10.0){%>
            <div class="pages">
                <a href="index_King.jsp?page=1" >首页</a>
                <%if (total-countaid != 10){%>
                <a href="index_King.jsp?page=<%=nowpage-1%>">上一页</a>
                <%}%>
                <% if (nowpage != allpages){%>
                    <a href="index_King.jsp?page=<%=nowpage+1%>">下一页</a>
                    <a href="index_King.jsp?page=<%=allpages%>">末页</a>
                <% } %>
                <form action="index_King.jsp">
